...
DEFAULT_RUNTIME_BANK_VERSION = "2026-06-12-baseline"
DEFAULT_RUNTIME_BANK_VERSION_ID = f"{DEFAULT_CONTENT_BANK_ID}:{DEFAULT_RUNTIME_BANK_VERSION}"
...
IMPORT_CONTENT_BANK_LANGUAGE_CODES = {
    DEFAULT_CONTENT_BANK_ID: DEFAULT_LANGUAGE_CODE,
    "english-core": "en",
}

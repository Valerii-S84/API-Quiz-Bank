...
Status: local-only/internal closed pilot evidence, protected public route smoke
and Public MVP / Protected Beta worker real-send evidence are recorded.
Production, broad public, school and paid launch scopes remain separate.
...
| Telegram dry-run | done for local-only VPS; local worker dry-run path added | `reports/pre_pilot/telegram_dry_run_readiness_2026-05-08.md`, `tools/run_telegram_delivery_smoke.py` | Production Telegram monitoring remains separate. |
...
| Telegram controlled real send | direct send done; deployed worker real-send done for Public MVP / Protected Beta | `reports/pre_pilot/telegram_controlled_send_2026-05-08.md`, `reports/beta/closed_external_pilot_smoke_2026-05-08.md`, `reports/roadmap/public_mvp_go_no_go_2026-05-08.md` | Production Telegram monitoring and incident evidence remain separate. |

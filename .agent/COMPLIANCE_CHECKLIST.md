...
Цей документ є optional startup audit helper.
Агент виконує його тільки якщо це прямо попросив користувач або якщо
активний entrypoint `.agent/AGENTS.md` прямо вимагає виконання цього
checklist для поточної задачі.
